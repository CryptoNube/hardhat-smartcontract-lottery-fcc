...
// Winner to be selected every x minutes -> completely aoutomated
...
error Raffle__UpkeepNotNeeded(uint256 currentBalance, uint256 numPlayers, uint256 raffelState);
...
contract Raffle is VRFConsumerBaseV2, AutomationCompatibleInterface {
     ...
     * 1. Our time interval needs to have passed
